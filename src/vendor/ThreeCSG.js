/* eslint-disable */
// Reason: Library code copied
// from https://evanw.github.io/csg.js/csg.js and
// https://rawgit.com/chandlerprall/ThreeCSG/master/ThreeCSG.js
  ...
  splitPolygon: function(polygon, coplanarFront, coplanarBack, front, back) {
    ...
    for (var i = 0; i < polygon.vertices.length; i++) {
      ...
      var type =
        t < -CSG.Plane.EPSILON
          ? BACK
          : t > CSG.Plane.EPSILON ? FRONT : COPLANAR;
      polygonType |= type;
      types.push(type);
    }
